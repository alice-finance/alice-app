...
const StartSavingButton = ({ disabled = false }) => {
    ...
    return (
        <Button primary={true} rounded={true} disabled={disabled} onPress={onStart} style={preset.flex1}>
            <Text style={preset.fontSize16}>{t("startSaving")}</Text>
        </Button>
    );
};

export default StartSavingButton;
